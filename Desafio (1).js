...
function eliminarPropiedad(objeto, unaPropiedad) {
  ...
  // Devuelve el objeto
  // Tu código:
  delete eliminarPropiedad.objeto[propiedad]
  return objeto;
...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // Tu código:
  usuarios.amigo.push(nuevoAmigo);
  return usuario;
}
...
let suma = 0 ;
for ( let i = 0; i < usuarios.post.length; i++ ){
